...
/**
 * This class implements the show-field command. It provides the regex to initially match the input against and is able
...
public class ShowFieldCommand extends Command {
     ...
     */
    public ShowFieldCommand(FireBreaker game) {
        super(game);
    }
